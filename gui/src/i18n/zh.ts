...
export const zh: Record<TKey, string> = {
  ...
  "nav.section": "分区导航",
  "aura.title": "Aura 设置",
  "aura.subtitle": "连接提供方和编码客户端，然后选择 Aura 的路由方式。",
  "aura.providers": "提供方",
  "aura.providersHint": "已启用 {n} 个",
  "aura.openProviders": "管理提供方",
  "aura.profile": "路由配置",
  "aura.profileHint": "为各角色选择成本与质量的平衡。",
  "aura.editRoles": "编辑角色模型",
  "aura.clients": "编码客户端",
  "aura.clientsHint": "从 Codex、Claude Code、OpenCode 和未来适配器使用 Aura。",
  "clients.codex.hint": "Codex 使用 Aura 的 Responses 端点，并通过账户与模型目录设置进行管理。",
  "clients.claude-code.hint": "将 Claude Code 连接到 Aura 的 Messages 端点；高级别名与上下文设置仍可使用。",
  "clients.opencode.hint": "预览并应用 OpenCode 的 Aura 提供商配置，支持受保护的备份与恢复。",
  "clients.zcode.hint": "尚未验证稳定且可由程序配置的集成接口。",
  "clients.noStableProtocol": "无稳定协议",
  "clients.preview": "预览更改",
  "clients.previewReady": "配置预览已准备好。",
  "clients.previewFailed": "无法预览客户端配置。",
  "clients.previewPath": "目标",
  "clients.previewChanges": "更改路径",
  "clients.connected": "客户端已连接。",
  "clients.disconnected": "客户端已断开。",
  "clients.disconnect": "断开连接",
  "clients.advanced": "高级设置",
  "clients.experimental": "实验性 — 仅支持手动设置。",
  "clients.claude-desktop.hint": "通过受保护的模型目录、备份、验证和恢复，将 Claude Desktop 连接到 Aura。",
  "clients.claudeDesktopMode": "Claude Desktop 模式",
  "clients.claudeDesktopModels": "可用 Aura 模型：{count}",
  "clients.claudeDesktopBackupReady": "已有可恢复的配置备份。",
  "clients.claudeDesktopBackupOnApply": "应用前 Aura 会创建备份。",
  "clients.claudeDesktopConnected": "Claude Desktop 已连接。请重启以加载模型目录。",
  "clients.claudeDesktopRestored": "Claude Desktop 配置已恢复。",
  "clients.compatibleModels": "兼容模型",
  "clients.searchModels": "搜索模型",
  "clients.selectAllCompatible": "全选兼容模型",
  "clients.clearModels": "清除选择",
  "clients.defaultModel": "默认模型",
  "clients.connectAllHint": "Aura 会将所有选中的模型注册到 OpenCode；默认模型用于启动新会话。",
  "aura.openCodeModel": "OpenCode 模型",
  "aura.connect": "连接 OpenCode",
  "aura.reconnect": "更新 OpenCode",
  "aura.restore": "恢复 OpenCode",
  "aura.connectedState": "已连接",
  "aura.notConnected": "未连接",
  "aura.connected": "OpenCode 已连接。",
  "aura.restored": "OpenCode 配置已恢复。",
  "aura.saved": "路由配置已保存。",
  "aura.loadFail": "无法加载 Aura 设置。",
  "aura.actionFail": "Aura 操作失败。",
  "wizard.title": "快速设置",
  "wizard.subtitle": "连接提供商，选择模型和编程客户端，然后应用路由配置。",
  ...
  "wizard.test": "测试连接",
  "wizard.testPassed": "提供商连接成功。",
  "wizard.testFailed": "提供商连接失败。",
  "wizard.continue": "继续",
  "wizard.back": "返回",
  "wizard.reviewHint": "Aura 将应用所选配置，并使用此模型进行编排。",
  "wizard.apply": "应用设置",
  "wizard.applied": "Aura 设置已应用。",
  "wizard.readyTitle": "Aura 已就绪",
  "wizard.readyHint": "提供商、模型、客户端和路由配置均已连接。",
  "wizard.change": "更改设置",
  "wizard.collapse": "收起设置",
  "visual.profileAria": "{profile} 配置平衡",
  "visual.efficiency": "效率",
  "visual.quality": "质量",
  "visual.autonomy": "自主性",
  "visual.agents": "{n} 个代理",
  "visual.budget": "{n} token 预算",
  "visual.pending": "尚未选择",
  "visual.routeTitle": "Aura 将更改什么",
  "visual.routeHint": "实时预览每个编码请求将经过的路径。",
  "visual.ready": "已就绪",
  "visual.preview": "预览",
  "visual.savingRate": "Token 节省率 {n}%",
  "visual.before": "之前",
  "visual.after": "之后",
  ...
  "theme.system": "跟随系统",
  "appearance.title": "外观",
  "appearance.subtitle": "选择 Aura 如何使用可用的窗口空间。",
  "appearance.layoutTitle": "内容布局",
  "appearance.layoutHint": "在专注阅读流与响应式多栏工作区之间即时切换。",
  "appearance.focus": "专注",
  "appearance.focusHint": "舒适阅读宽度的简洁单栏布局。",
  "appearance.canvas": "画布",
  "appearance.canvasHint": "利用额外宽度展示卡片和对比内容的自适应工作区。",
  "appearance.live": "立即生效",
  "lang.label": "语言",
  ...
  "usage.optimizer.status": "Aura 优化器",
  "usage.optimizer.enabled": "已启用",
  "usage.optimizer.disabled": "已禁用",
  "usage.optimizer.saved": "{actions} 次转换共节省 {tokens} 个令牌",
  "logs.detail.optimizer": "优化器",
  "logs.detail.optimizerValue": "{actions} 次转换 · 节省 {tokens} 个令牌",
  "logs.detail.section.basic": "基本信息",
  "logs.detail.auraClient": "Aura 客户端 / 协议",
  "logs.detail.auraProfile": "Aura 配置档",
  "logs.detail.auraRole": "Aura 角色",
  "logs.detail.auraReason": "路由决策",
  ...
  "common.close": "关闭",
  "common.ok": "确定",
  "app.logoAria": "Aura AI 徽标",
  "app.claudeOn": "Claude 开",
  "app.claudeOff": "Claude 关",
  "app.claudeCliOn": "Claude Code CLI 开",
  "app.claudeCliOff": "Claude Code CLI 关",
  "usage.dayMon": "一",
  "usage.dayWed": "三",
  "usage.dayFri": "五",
  ...
  "pws.retry": "重试",
  "pws.capabilityTitle": "能力报告",
  "pws.capabilityProtocol": "协议",
  "pws.capabilityCompact": "压缩",
  "pws.capabilityReasoning": "推理",
  "pws.capabilityVision": "视觉",
  "pws.capabilityDeclared": "已声明",
  "pws.capabilityUnknown": "未声明",
  "pws.capabilityProbe": "测试发现",
  "pws.capabilityProbing": "测试中…",
  "pws.capabilityProbeOk": "模型发现于 {latency} 毫秒内响应。",
  "pws.capabilityProbeFailed": "提供商模型发现测试失败。",
  "pws.capabilityProbeNetwork": "测试提供商模型发现时发生网络错误。",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "nav.integrations": "集成",
  "integrations.eyebrow": "Aura 连接",
  "integrations.title": "集成",
  "integrations.subtitle": "一次连接开发服务，然后将安全能力共享给兼容的编码代理。",
  "integrations.refresh": "刷新",
  "integrations.vaultTitle": "凭据保存在 Aura 后面",
  "integrations.vaultHint": "Aura 只保存连接元数据；密钥保留在系统保险库或服务商 OAuth 流程中。",
  "integrations.oneTime": "一次性设置",
  "integrations.search": "搜索集成",
  "integrations.searchPlaceholder": "搜索 GitHub、Supabase、部署、监控...",
  "integrations.empty": "没有匹配的集成。",
  "integrations.connected": "已连接",
  "integrations.pending": "需要登录",
  "integrations.available": "可用",
  "integrations.autoClients": "{n} 个代理可自动连接",
  "integrations.connect": "连接",
  "integrations.docs": "文档",
  "integrations.loadError": "无法加载 Aura 集成。",
  "integrations.category.code": "代码与源代码",
  "integrations.category.backend": "数据库与后端",
  "integrations.category.deploy": "部署",
  "integrations.category.monitoring": "监控",
  "integrations.category.project": "项目管理",
  "integrations.category.communication": "沟通",
  "integrations.prepare": "准备连接",
  "integrations.prepareTitle": "准备 {name}",
  "integrations.prepareHint": "现在选择项目和最小权限。此步骤 Aura 不保存密钥；认证仍在官方服务商流程中完成。",
  "integrations.connectionLabel": "连接名称",
  "integrations.resource": "项目或工作区（可选）",
  "integrations.resourcePlaceholder": "例如：production、acme/web-app",
  "integrations.authMode": "认证方式",
  "integrations.scopes": "允许的能力",
