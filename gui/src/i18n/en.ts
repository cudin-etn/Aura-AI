...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.vaultHint": "Aura stores connection metadata here; API keys stay in Aura's local protected vault and OAuth stays in the provider's official flow.",
