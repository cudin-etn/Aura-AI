...
export const en = {
  ...
  "nav.profiles": "Profiles & roles",
  "nav.fallback": "Fallback",
  "nav.primary": "Primary navigation",
  "nav.section": "Section navigation",
  "aura.title": "Aura Setup",
  "aura.subtitle": "Connect providers and coding clients, then choose how Aura routes work.",
  "aura.providers": "Providers",
  "aura.providersHint": "{n} enabled",
  "aura.openProviders": "Manage providers",
  "aura.profile": "Routing profile",
  "aura.profileHint": "Choose the cost and quality balance for each role.",
  "aura.editRoles": "Edit role models",
  "aura.clients": "Coding clients",
  "aura.clientsHint": "Use Aura from Codex, Claude Code, OpenCode, and future adapters.",
  "clients.codex.hint": "Codex uses Aura's Responses endpoint and is managed through accounts and model catalog settings.",
  "clients.claude-code.hint": "Connect Claude Code to Aura's Messages endpoint; advanced aliases and context settings remain available.",
  "clients.opencode.hint": "Preview and apply an Aura provider entry to OpenCode with guarded backup and restore.",
  "clients.zcode.hint": "Use the guided manual setup for ZCode's compatible provider fields; automatic file editing is intentionally disabled.",
  "clients.factory.hint": "Preview and apply a guarded custom model entry to Factory Droid, with backup and restore.",
  "clients.generic.hint": "Get copy-ready endpoints and steps for any AI coding agent with a compatible API.",
  "clients.noStableProtocol": "No stable protocol",
  "clients.preview": "Preview changes",
  "clients.previewReady": "Configuration preview is ready.",
  "clients.previewFailed": "Could not preview the client configuration.",
  "clients.previewPath": "Target",
  "clients.previewChanges": "Changed paths",
  "clients.connected": "Client connected.",
  "clients.disconnected": "Client disconnected.",
  "clients.disconnect": "Disconnect",
  "clients.advanced": "Advanced settings",
  "clients.experimental": "Experimental — manual setup only.",
  "clients.claude-desktop.hint": "Connect Claude Desktop to Aura with a guarded model catalog, backup, verification, and restore.",
  "clients.claudeDesktopMode": "Claude Desktop mode",
  "clients.claudeDesktopModels": "{count} Aura models will be available",
  "clients.claudeDesktopBackupReady": "A previous configuration backup is ready for restore.",
  "clients.claudeDesktopBackupOnApply": "Aura creates a backup before applying.",
  "clients.claudeDesktopConnected": "Claude Desktop connected. Restart Claude Desktop to load the catalog.",
  "clients.claudeDesktopRestored": "Claude Desktop configuration restored.",
  "clients.compatibleModels": "Compatible models",
  "clients.searchModels": "Search models",
  "clients.selectAllCompatible": "Select all compatible",
  "clients.clearModels": "Clear",
  "clients.defaultModel": "Default model",
  "clients.connectAllHint": "Aura registers every selected model in OpenCode; the default is used to start new sessions.",
  "clients.factoryConnected": "Factory Droid connected.",
  "clients.factoryRestored": "Factory Droid configuration restored.",
  "clients.openGuide": "Open setup guide",
  "clients.copyGuide": "Copy connection details",
  "clients.guideCopied": "Connection details copied.",
  "clients.guideFailed": "Could not load the setup guide.",
  "clients.guideBaseUrl": "Base URL",
  "clients.guideModel": "Model",
  "clients.guideSteps": "Manual setup steps",
  "clients.guideStepOne": "Choose OpenAI Responses, Chat Completions, or Anthropic Messages — whichever your client supports.",
  "clients.guideStepTwo": "Set the matching Aura endpoint and choose the model shown above.",
  "clients.guideStepThree": "Leave the API key empty for an unauthenticated local Aura instance; otherwise use an Aura key or the configured environment variable.",
  ...
  "aura.openCodeModel": "OpenCode model",
  "aura.connect": "Connect OpenCode",
  "aura.reconnect": "Update OpenCode",
  "aura.restore": "Restore OpenCode",
  "aura.factoryModel": "Factory Droid model",
  "aura.connectFactory": "Connect Factory Droid",
  "aura.restoreFactory": "Restore Factory Droid",
  "aura.connectedState": "Connected",
  "aura.notConnected": "Not connected",
  "aura.connected": "OpenCode connected.",
  "aura.restored": "OpenCode configuration restored.",
  "aura.saved": "Routing profile saved.",
  "aura.loadFail": "Aura setup could not be loaded.",
  "aura.actionFail": "The Aura action failed.",
  "aura.capabilitiesTitle": "Capabilities",
  "aura.capabilitiesHint": "See what Aura can route today and what is still planned.",
  "aura.capability.available": "Available",
  "aura.capability.partial": "Partial",
  "aura.capability.planned": "Planned",
  "aura.tokenSaverTitle": "Token Saver",
  "aura.tokenSaverHint": "Conservative, measured reductions for routed tool output and logs.",
  "aura.tokenSaverEnabled": "Enable optimizer",
  "aura.tokenSaverMeasured": "Every transformation is recorded in Insights.",
  "aura.tokenSaverDedup": "Deduplicate repeated tool output",
  "aura.tokenSaverLogs": "Reduce oversized logs with local retrieval",
  "aura.tokenSaver.lite": "Lite",
  "aura.tokenSaver.off": "Off",
  "aura.tokenSaver.safe": "Safe",
  ...
  "wizard.title": "Quick setup",
  "wizard.subtitle": "Connect a provider, choose a model and coding client, then apply a routing profile.",
  "wizard.step": "Step {current} of {total}",
  "wizard.provider": "Provider",
  "wizard.model": "Model",
  "wizard.client": "Coding client",
  "wizard.review": "Review",
  "wizard.addProvider": "Add provider",
  "wizard.test": "Test connection",
  "wizard.testPassed": "Provider connection passed.",
  "wizard.testFailed": "Provider connection failed.",
  ...
  "wizard.readyHint": "Provider, model, client, and routing profile are connected.",
  "wizard.change": "Change setup",
  "wizard.collapse": "Hide setup",
  "visual.profileAria": "{profile} profile balance",
  "visual.efficiency": "Efficiency",
  "visual.quality": "Quality",
  "visual.autonomy": "Autonomy",
  "visual.agents": "{n} agents",
  "visual.budget": "{n} token budget",
  "visual.pending": "Not selected",
  "visual.routeTitle": "What Aura will change",
  "visual.routeHint": "A live preview of the path each coding request will follow.",
  "visual.ready": "Ready",
  "visual.preview": "Preview",
  "visual.savingRate": "{n}% token saving rate",
  ...
  "app.claudeCliOn": "Claude Code CLI ON",
  "app.claudeCliOff": "Claude Code CLI OFF",
  "theme.label": "Theme",
  "theme.light": "Light",
  "theme.dark": "Dark",
  "theme.system": "System",
  "appearance.title": "Appearance",
  "appearance.subtitle": "Choose how Aura uses the available window space.",
  "appearance.layoutTitle": "Content layout",
  "appearance.layoutHint": "Switch instantly between a focused reading flow and a responsive multi-column workspace.",
  "appearance.focus": "Focus",
  "appearance.focusHint": "A calm single-column flow with a comfortable reading width.",
  "appearance.canvas": "Canvas",
  "appearance.canvasHint": "An adaptive workspace that uses extra width for cards and comparisons.",
  "appearance.live": "Applies instantly",
  "lang.label": "Language",
  ...
  "usage.optimizer.status": "Aura optimizer",
  "usage.optimizer.enabled": "Enabled",
  "usage.optimizer.disabled": "Disabled",
  "usage.optimizer.saved": "{tokens} tokens saved across {actions} transformations",
  "logs.detail.optimizer": "Optimizer",
  "logs.detail.optimizerValue": "{actions} transformations · {tokens} tokens saved",
  "logs.detail.section.basic": "Basic information",
  "logs.detail.auraClient": "Aura client / protocol",
  "logs.detail.auraProfile": "Aura profile",
  "logs.detail.auraRole": "Aura role",
  "logs.detail.auraReason": "Route decision",
  "logs.route.profile_match": "Kept the requested model",
  "logs.route.manual_override": "Manual model choice kept",
  "logs.route.auto_safe": "Auto Safe selected a GPT model for this role",
  "logs.route.auto_adaptive": "Auto Adaptive selected a GPT model for this role",
  "logs.route.risk_escalation": "Escalated for an explicit risk signal",
  "logs.route.verification_escalation": "Escalated after repeated verification failures",
  ...
  "pws.retry": "Retry",
  "pws.capabilityTitle": "Capability report",
  "pws.capabilityProtocol": "Protocol",
  "pws.capabilityCompact": "Compact",
  "pws.capabilityReasoning": "Reasoning",
  "pws.capabilityVision": "Vision",
  "pws.capabilityDeclared": "declared",
  "pws.capabilityUnknown": "not declared",
  "pws.capabilityProbe": "Test discovery",
  "pws.capabilityProbing": "Testing…",
  "pws.capabilityProbeOk": "Discovery responded in {latency} ms.",
  "pws.capabilityProbeFailed": "Provider discovery test failed.",
  "pws.capabilityProbeNetwork": "Network error while testing provider discovery.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.eyebrow": "Aura connections",
  "integrations.title": "Integrations",
  "integrations.subtitle": "Connect your development services once, then share safe capabilities with compatible coding agents.",
  "integrations.refresh": "Refresh",
  "integrations.vaultTitle": "Credentials stay behind Aura",
  "integrations.vaultHint": "Connect once. API keys stay inside Aura.",
  "integrations.oneTime": "One-time setup",
  "integrations.search": "Search integrations",
  "integrations.searchPlaceholder": "Search GitHub, Supabase, deploy, monitoring...",
  "integrations.empty": "No integrations match this search.",
  "integrations.connected": "Connected",
  "integrations.pending": "Needs login",
  "integrations.available": "Available",
  "integrations.autoClients": "{n} agents can auto-connect",
  "integrations.connect": "Connect",
  "integrations.docs": "Docs",
  "integrations.loadError": "Could not load Aura integrations.",
  "integrations.category.code": "Code & source",
  "integrations.category.backend": "Database & backend",
  "integrations.category.deploy": "Deploy",
  "integrations.category.monitoring": "Monitoring",
  "integrations.category.project": "Project management",
  "integrations.category.communication": "Communication",
  "integrations.prepare": "Prepare connection",
  "integrations.catalog": "View setup",
  "integrations.catalogHint": "Aura can export a ready-to-paste MCP setup for this service today. The upstream connector itself is not enabled yet, so no credential or permission is saved here.",
  "integrations.catalogNext": "Next: complete authentication with the service, then copy or apply Aura MCP for your coding agent.",
  "sub.routerTitle": "Smart GPT Router",
  "sub.routerHint": "Uses {count} eligible GPT models. It only changes a model at a request boundary and always records why.",
  "sub.router.manual": "Manual",
  "sub.router.safe": "Auto Safe",
  "sub.router.adaptive": "Auto Adaptive",
  "integrations.prepareTitle": "Prepare {name}",
  "integrations.prepareHint": "Choose the intended project and minimum capabilities now. API keys remain in Aura's protected local vault; OAuth stays in the provider's official flow.",
  "integrations.connectionLabel": "Connection name",
  "integrations.resource": "Project or workspace (optional)",
  "integrations.resourcePlaceholder": "For example: production, acme/web-app",
  "integrations.authMode": "Authentication method",
  "integrations.scopes": "Allowed capabilities",
  "integrations.prepareError": "Could not prepare the integration connection.",
  "integrations.apiKey": "API key",
  "integrations.apiKeyPlaceholder": "Stored in Aura's local secret vault",
  ...
  "integrations.exportDestination": "Add to",
  "integrations.mcpApplyCodex": "Apply to Codex (backup)",
  "integrations.mcpRestoreCodex": "Restore Codex MCP",
  "integrations.mcpApplyError": "Could not apply the Aura MCP configuration to Codex.",
