...
export const ko: Record<TKey, string> = {
  ...
  "nav.accounts": "계정",
  "nav.clients": "클라이언트",
  "nav.profiles": "프로필 및 역할",
  "nav.fallback": "대체 경로",
  "nav.primary": "기본 탐색",
  "nav.section": "섹션 탐색",
  "aura.title": "Aura 설정",
  "aura.subtitle": "프로바이더와 코딩 클라이언트를 연결하고 라우팅 방식을 선택합니다.",
  "aura.providers": "프로바이더",
  "aura.providersHint": "{n}개 활성화",
  "aura.openProviders": "프로바이더 관리",
  "aura.profile": "라우팅 프로필",
  "aura.profileHint": "역할별 비용과 품질 균형을 선택합니다.",
  "aura.editRoles": "역할 모델 편집",
  "aura.clients": "코딩 클라이언트",
  "aura.clientsHint": "Codex, Claude Code, OpenCode 및 향후 어댑터에서 Aura를 사용합니다.",
  "clients.codex.hint": "Codex는 Aura의 Responses 엔드포인트를 사용하며 계정 및 모델 카탈로그 설정에서 관리됩니다.",
  "clients.claude-code.hint": "Claude Code를 Aura의 Messages 엔드포인트에 연결하며 고급 별칭 및 컨텍스트 설정도 사용할 수 있습니다.",
  "clients.opencode.hint": "보호된 백업과 복원을 사용해 OpenCode의 Aura 제공자 항목을 미리 보고 적용합니다.",
  "clients.zcode.hint": "안정적인 기계 구성 가능 통합 표면은 아직 검증되지 않았습니다.",
  "clients.noStableProtocol": "안정적인 프로토콜 없음",
  "clients.preview": "변경 사항 미리 보기",
  "clients.previewReady": "구성 미리 보기가 준비되었습니다.",
  "clients.previewFailed": "클라이언트 구성을 미리 볼 수 없습니다.",
  "clients.previewPath": "대상",
  "clients.previewChanges": "변경 경로",
  "clients.connected": "클라이언트가 연결되었습니다.",
  "clients.disconnected": "클라이언트 연결이 해제되었습니다.",
  "clients.disconnect": "연결 해제",
  "clients.advanced": "고급 설정",
  "clients.experimental": "실험적 — 수동 설정만 지원합니다.",
  "clients.claude-desktop.hint": "보호된 모델 카탈로그, 백업, 검증 및 복원을 사용해 Claude Desktop을 Aura에 연결합니다.",
  "clients.claudeDesktopMode": "Claude Desktop 모드",
  "clients.claudeDesktopModels": "Aura 모델 {count}개 사용 가능",
  "clients.claudeDesktopBackupReady": "복원할 수 있는 구성 백업이 있습니다.",
  "clients.claudeDesktopBackupOnApply": "적용 전에 Aura가 백업을 만듭니다.",
  "clients.claudeDesktopConnected": "Claude Desktop이 연결되었습니다. 카탈로그를 불러오려면 재시작하세요.",
  "clients.claudeDesktopRestored": "Claude Desktop 구성을 복원했습니다.",
  "clients.compatibleModels": "호환 모델",
  "clients.searchModels": "모델 검색",
  "clients.selectAllCompatible": "호환 모델 모두 선택",
  "clients.clearModels": "선택 해제",
  "clients.defaultModel": "기본 모델",
  "clients.connectAllHint": "Aura가 선택한 모든 모델을 OpenCode에 등록하며, 기본 모델은 새 세션에 사용됩니다.",
  "aura.openCodeModel": "OpenCode 모델",
  "aura.connect": "OpenCode 연결",
  "aura.reconnect": "OpenCode 업데이트",
  "aura.restore": "OpenCode 복원",
  "aura.connectedState": "연결됨",
  "aura.notConnected": "연결 안 됨",
  "aura.connected": "OpenCode가 연결되었습니다.",
  "aura.restored": "OpenCode 설정이 복원되었습니다.",
  "aura.saved": "라우팅 프로필이 저장되었습니다.",
  "aura.loadFail": "Aura 설정을 불러오지 못했습니다.",
  "aura.actionFail": "Aura 작업에 실패했습니다.",
  "wizard.title": "빠른 설정",
  "wizard.subtitle": "공급자를 연결하고 모델과 코딩 클라이언트를 선택한 다음 라우팅 프로필을 적용합니다.",
  "wizard.step": "{total}단계 중 {current}단계",
  "wizard.provider": "공급자",
  "wizard.model": "모델",
  "wizard.client": "코딩 클라이언트",
  "wizard.review": "검토",
  "wizard.addProvider": "공급자 추가",
  "wizard.test": "연결 테스트",
  "wizard.testPassed": "공급자 연결에 성공했습니다.",
  "wizard.testFailed": "공급자 연결에 실패했습니다.",
  "wizard.continue": "계속",
  "wizard.back": "뒤로",
  "wizard.reviewHint": "선택한 프로필을 적용하고 이 모델을 오케스트레이션에 사용합니다.",
  "wizard.apply": "설정 적용",
  "wizard.applied": "Aura 설정을 적용했습니다.",
  "wizard.readyTitle": "Aura 준비 완료",
  "wizard.readyHint": "제공자, 모델, 클라이언트, 라우팅 프로필이 연결되었습니다.",
  "wizard.change": "설정 변경",
  "wizard.collapse": "설정 숨기기",
  "visual.profileAria": "{profile} 프로필 균형",
  "visual.efficiency": "효율",
  "visual.quality": "품질",
  "visual.autonomy": "자율성",
  "visual.agents": "에이전트 {n}개",
  "visual.budget": "토큰 예산 {n}",
  "visual.pending": "선택 안 됨",
  "visual.routeTitle": "Aura가 변경할 내용",
  "visual.routeHint": "각 코딩 요청이 이동할 경로를 실시간으로 미리 봅니다.",
  "visual.ready": "준비됨",
  "visual.preview": "미리보기",
  "visual.savingRate": "토큰 절감률 {n}%",
  "visual.before": "이전",
  "visual.after": "이후",
  ...
  "appearance.subtitle": "Aura가 창 공간을 사용하는 방식을 선택합니다.",
  "appearance.layoutTitle": "콘텐츠 레이아웃",
  "appearance.layoutHint": "집중형 읽기 흐름과 반응형 다단 작업 공간을 즉시 전환합니다.",
  "appearance.focus": "집중",
  "appearance.focusHint": "편안한 읽기 너비의 차분한 단일 열 흐름입니다.",
  "appearance.canvas": "캔버스",
  "appearance.canvasHint": "추가 너비를 카드와 비교에 활용하는 적응형 작업 공간입니다.",
  "appearance.live": "즉시 적용",
  "lang.label": "언어",
  ...
  "usage.optimizer.status": "Aura 최적화",
  "usage.optimizer.enabled": "사용",
  "usage.optimizer.disabled": "사용 안 함",
  "usage.optimizer.saved": "{actions}회 변환에서 {tokens} 토큰 절약",
  "logs.detail.optimizer": "최적화",
  "logs.detail.optimizerValue": "{actions}회 변환 · {tokens} 토큰 절약",
  "logs.detail.section.basic": "기본 정보",
  "logs.detail.auraClient": "Aura 클라이언트 / 프로토콜",
  "logs.detail.auraProfile": "Aura 프로필",
  "logs.detail.auraRole": "Aura 역할",
  "logs.detail.auraReason": "라우팅 결정",
  ...
  "pws.retry": "다시 시도",
  "pws.capabilityTitle": "기능 보고서",
  "pws.capabilityProtocol": "프로토콜",
  "pws.capabilityCompact": "컴팩트",
  "pws.capabilityReasoning": "추론",
  "pws.capabilityVision": "비전",
  "pws.capabilityDeclared": "선언됨",
  "pws.capabilityUnknown": "선언되지 않음",
  "pws.capabilityProbe": "검색 테스트",
  "pws.capabilityProbing": "테스트 중…",
  "pws.capabilityProbeOk": "검색이 {latency}ms 안에 응답했습니다.",
  "pws.capabilityProbeFailed": "제공자 검색 테스트에 실패했습니다.",
  "pws.capabilityProbeNetwork": "제공자 검색 테스트 중 네트워크 오류가 발생했습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "aura.tokenSaver.off": "끔",
  "aura.tokenSaver.safe": "안전",
  ...
  "nav.integrations": "통합",
  "integrations.eyebrow": "Aura 연결",
  "integrations.title": "통합",
  "integrations.subtitle": "개발 서비스를 한 번 연결하고 호환되는 코딩 클라이언트에 안전한 기능을 공유합니다.",
  "integrations.refresh": "새로 고침",
  "integrations.vaultTitle": "자격 증명은 Aura 뒤에 보관됩니다",
  "integrations.vaultHint": "Aura에는 연결 메타데이터만 저장하고 비밀 정보는 플랫폼 보관함 또는 OAuth 흐름에 남깁니다.",
  "integrations.oneTime": "한 번만 설정",
  "integrations.search": "통합 검색",
  "integrations.searchPlaceholder": "GitHub, Supabase, 배포, 모니터링 검색...",
  "integrations.empty": "검색과 일치하는 통합이 없습니다.",
  "integrations.connected": "연결됨",
  "integrations.pending": "로그인 필요",
  "integrations.available": "사용 가능",
  "integrations.autoClients": "{n}개 에이전트 자동 연결 가능",
  "integrations.connect": "연결",
  "integrations.docs": "문서",
  "integrations.loadError": "Aura 통합을 불러오지 못했습니다.",
  "integrations.category.code": "코드 및 소스",
  "integrations.category.backend": "데이터베이스 및 백엔드",
  "integrations.category.deploy": "배포",
  "integrations.category.monitoring": "모니터링",
  "integrations.category.project": "프로젝트 관리",
  "integrations.category.communication": "커뮤니케이션",
  "integrations.prepare": "연결 준비",
  "integrations.prepareTitle": "{name} 준비",
  "integrations.prepareHint": "프로젝트와 최소 권한을 선택합니다. 이 단계에서 Aura는 비밀 정보를 저장하지 않으며 인증은 공식 제공자 흐름으로 진행됩니다.",
  "integrations.connectionLabel": "연결 이름",
  "integrations.resource": "프로젝트 또는 워크스페이스(선택 사항)",
  "integrations.resourcePlaceholder": "예: production, acme/web-app",
  "integrations.authMode": "인증 방법",
  "integrations.scopes": "허용된 기능",
