...
export const ja: Record<TKey, string> = {
  ...
  "nav.accounts": "アカウント",
  "nav.clients": "クライアント",
  "nav.profiles": "プロファイルと役割",
  "nav.fallback": "フォールバック",
  "nav.primary": "メインナビゲーション",
  "nav.section": "セクションナビゲーション",
  "aura.title": "Aura セットアップ",
  "aura.subtitle": "プロバイダーとコーディングクライアントを接続し、ルーティング方法を選択します。",
  "aura.providers": "プロバイダー",
  "aura.providersHint": "{n} 件有効",
  "aura.openProviders": "プロバイダーを管理",
  "aura.profile": "ルーティングプロファイル",
  "aura.profileHint": "役割ごとのコストと品質のバランスを選択します。",
  "aura.editRoles": "役割モデルを編集",
  "aura.clients": "コーディングクライアント",
  "aura.clientsHint": "Codex、Claude Code、OpenCode、今後のアダプターから Aura を利用します。",
  "clients.codex.hint": "Codex は Aura の Responses エンドポイントを使用し、アカウントとモデルカタログで管理します。",
  "clients.claude-code.hint": "Claude Code を Aura の Messages エンドポイントに接続します。高度なエイリアスとコンテキスト設定も利用できます。",
  "clients.opencode.hint": "保護されたバックアップと復元を使って、OpenCode の Aura プロバイダー設定をプレビューして適用します。",
  "clients.zcode.hint": "安定した機械設定可能な統合インターフェースはまだ確認されていません。",
  "clients.noStableProtocol": "安定したプロトコルなし",
  "clients.preview": "変更をプレビュー",
  "clients.previewReady": "設定プレビューの準備ができました。",
  "clients.previewFailed": "クライアント設定をプレビューできませんでした。",
  "clients.previewPath": "対象",
  "clients.previewChanges": "変更パス",
  "clients.connected": "クライアントを接続しました。",
  "clients.disconnected": "クライアントを切断しました。",
  "clients.disconnect": "切断",
  "clients.advanced": "詳細設定",
  "clients.experimental": "実験的 — 手動設定のみ。",
  "clients.claude-desktop.hint": "Claude Desktop を Aura の保護されたモデルカタログ、バックアップ、検証、復元で接続します。",
  "clients.claudeDesktopMode": "Claude Desktop モード",
  "clients.claudeDesktopModels": "Aura の {count} モデルが利用可能です",
  "clients.claudeDesktopBackupReady": "復元用の設定バックアップがあります。",
  "clients.claudeDesktopBackupOnApply": "適用前に Aura がバックアップを作成します。",
  "clients.claudeDesktopConnected": "Claude Desktop に接続しました。カタログを読み込むには再起動してください。",
  "clients.claudeDesktopRestored": "Claude Desktop の設定を復元しました。",
  "clients.compatibleModels": "互換モデル",
  "clients.searchModels": "モデルを検索",
  "clients.selectAllCompatible": "互換モデルをすべて選択",
  "clients.clearModels": "クリア",
  "clients.defaultModel": "デフォルトモデル",
  "clients.connectAllHint": "Aura は選択したすべてのモデルを OpenCode に登録します。デフォルトモデルは新しいセッションで使われます。",
  "aura.openCodeModel": "OpenCode モデル",
  "aura.connect": "OpenCode を接続",
  "aura.reconnect": "OpenCode を更新",
  "aura.restore": "OpenCode を復元",
  "aura.connectedState": "接続済み",
  "aura.notConnected": "未接続",
  "aura.connected": "OpenCode を接続しました。",
  "aura.restored": "OpenCode の設定を復元しました。",
  "aura.saved": "ルーティングプロファイルを保存しました。",
  "aura.loadFail": "Aura セットアップを読み込めませんでした。",
  "aura.actionFail": "Aura の操作に失敗しました。",
  "wizard.title": "クイックセットアップ",
  "wizard.subtitle": "プロバイダーを接続し、モデルとコーディングクライアントを選び、ルーティングプロファイルを適用します。",
  "wizard.step": "ステップ {current} / {total}",
  "wizard.provider": "プロバイダー",
  "wizard.model": "モデル",
  "wizard.client": "コーディングクライアント",
  "wizard.review": "確認",
  "wizard.addProvider": "プロバイダーを追加",
  "wizard.test": "接続をテスト",
  "wizard.testPassed": "プロバイダーへの接続に成功しました。",
  "wizard.testFailed": "プロバイダーへの接続に失敗しました。",
  "wizard.continue": "続ける",
  "wizard.back": "戻る",
  "wizard.reviewHint": "選択したプロファイルを適用し、このモデルをオーケストレーションに使用します。",
  "wizard.apply": "設定を適用",
  "wizard.applied": "Aura の設定を適用しました。",
  "wizard.readyTitle": "Aura の準備ができました",
  "wizard.readyHint": "プロバイダー、モデル、クライアント、ルーティングプロファイルが接続されています。",
  "wizard.change": "設定を変更",
  "wizard.collapse": "設定を閉じる",
  "visual.profileAria": "{profile} プロファイルのバランス",
  "visual.efficiency": "効率",
  "visual.quality": "品質",
  "visual.autonomy": "自律性",
  "visual.agents": "{n} エージェント",
  "visual.budget": "{n} トークン予算",
  "visual.pending": "未選択",
  "visual.routeTitle": "Aura が変更する内容",
  "visual.routeHint": "各コーディングリクエストが通る経路をリアルタイムで確認します。",
  "visual.ready": "準備完了",
  "visual.preview": "プレビュー",
  "visual.savingRate": "トークン削減率 {n}%",
  "visual.before": "前",
  "visual.after": "後",
  ...
  "app.claudeCliOn": "Claude Code CLI オン",
  "app.claudeCliOff": "Claude Code CLI オフ",
  "theme.label": "テーマ",
  "theme.light": "ライト",
  "theme.dark": "ダーク",
  "theme.system": "システム",
  "appearance.title": "外観",
  "appearance.subtitle": "Aura が利用可能なウィンドウ領域をどう使うか選択します。",
  "appearance.layoutTitle": "コンテンツレイアウト",
  "appearance.layoutHint": "集中して読める表示とレスポンシブな複数列ワークスペースをすぐに切り替えます。",
  "appearance.focus": "フォーカス",
  "appearance.focusHint": "読みやすい幅に整えた落ち着いた単一列レイアウトです。",
  "appearance.canvas": "キャンバス",
  "appearance.canvasHint": "余分な幅をカードや比較表示に活用する適応型ワークスペースです。",
  "appearance.live": "すぐに反映",
  "lang.label": "言語",
  ...
  "usage.optimizer.status": "Aura オプティマイザー",
  "usage.optimizer.enabled": "有効",
  "usage.optimizer.disabled": "無効",
  "usage.optimizer.saved": "{actions} 回の変換で {tokens} トークンを節約",
  "logs.detail.optimizer": "オプティマイザー",
  "logs.detail.optimizerValue": "{actions} 回の変換 · {tokens} トークン節約",
  "logs.detail.section.basic": "基本情報",
  "logs.detail.auraClient": "Aura クライアント / プロトコル",
  "logs.detail.auraProfile": "Aura プロファイル",
  "logs.detail.auraRole": "Aura ロール",
  "logs.detail.auraReason": "ルート判断",
  ...
  "pws.retry": "再試行",
  "pws.capabilityTitle": "機能レポート",
  "pws.capabilityProtocol": "プロトコル",
  "pws.capabilityCompact": "コンパクト",
  "pws.capabilityReasoning": "推論",
  "pws.capabilityVision": "画像",
  "pws.capabilityDeclared": "宣言済み",
  "pws.capabilityUnknown": "未宣言",
  "pws.capabilityProbe": "検出をテスト",
  "pws.capabilityProbing": "テスト中…",
  "pws.capabilityProbeOk": "検出は {latency} ms で応答しました。",
  "pws.capabilityProbeFailed": "プロバイダー検出テストに失敗しました。",
  "pws.capabilityProbeNetwork": "プロバイダー検出のテスト中にネットワークエラーが発生しました。",
  ...
  "modal.localHint": "API キーは保存されません。Aura は上記のローカルエンドポイントを通じてのみ、このプロバイダーに接続します。",
  ...
  "aura.tokenSaver.off": "オフ",
  "aura.tokenSaver.safe": "安全",
  ...
  "nav.integrations": "連携",
  "integrations.eyebrow": "Aura の連携",
  "integrations.title": "連携",
  "integrations.subtitle": "開発サービスを一度接続し、対応するコーディングクライアントに安全な機能を共有します。",
  "integrations.refresh": "更新",
  "integrations.vaultTitle": "認証情報は Aura の内側に保持",
  "integrations.vaultHint": "Aura は接続メタデータのみ保存し、秘密情報は OS の保管庫または OAuth フローに残します。",
  "integrations.oneTime": "一度だけ設定",
  "integrations.search": "連携を検索",
  "integrations.searchPlaceholder": "GitHub、Supabase、デプロイ、監視を検索...",
  "integrations.empty": "検索に一致する連携はありません。",
  "integrations.connected": "接続済み",
  "integrations.pending": "ログインが必要",
  "integrations.available": "利用可能",
  "integrations.autoClients": "{n} 個のエージェントが自動接続可能",
  "integrations.connect": "接続",
  "integrations.docs": "ドキュメント",
  "integrations.loadError": "Aura の連携を読み込めませんでした。",
  "integrations.category.code": "コードとソース",
  "integrations.category.backend": "データベースとバックエンド",
  "integrations.category.deploy": "デプロイ",
  "integrations.category.monitoring": "監視",
  "integrations.category.project": "プロジェクト管理",
  "integrations.category.communication": "コミュニケーション",
  "integrations.prepare": "接続を準備",
  "integrations.prepareTitle": "{name} を準備",
  "integrations.prepareHint": "プロジェクトと最小権限を選択します。この段階で Aura は秘密情報を保存せず、認証は公式プロバイダーフローで行われます。",
  "integrations.connectionLabel": "接続名",
  "integrations.resource": "プロジェクトまたはワークスペース（任意）",
  "integrations.resourcePlaceholder": "例: production、acme/web-app",
  "integrations.authMode": "認証方法",
  "integrations.scopes": "許可する機能",
