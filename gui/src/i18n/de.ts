...
export const de = {
  ...
  "nav.accounts": "Konten",
  "nav.clients": "Clients",
  "nav.profiles": "Profile & Rollen",
  "nav.fallback": "Fallback",
  "nav.primary": "Hauptnavigation",
  "nav.section": "Bereichsnavigation",
  "aura.title": "Aura-Einrichtung",
  "aura.subtitle": "Anbieter und Coding-Clients verbinden und das Routing festlegen.",
  "aura.providers": "Anbieter",
  "aura.providersHint": "{n} aktiviert",
  "aura.openProviders": "Anbieter verwalten",
  "aura.profile": "Routing-Profil",
  "aura.profileHint": "Kosten und Qualität für jede Rolle ausbalancieren.",
  "aura.editRoles": "Rollenmodelle bearbeiten",
  "aura.clients": "Coding-Clients",
  "aura.clientsHint": "Aura mit Codex, Claude Code, OpenCode und künftigen Adaptern nutzen.",
  "clients.codex.hint": "Codex nutzt Auras Responses-Endpunkt und wird über Konten und Modellkatalog verwaltet.",
  "clients.claude-code.hint": "Claude Code mit Auras Messages-Endpunkt verbinden; erweiterte Alias- und Kontexteinstellungen bleiben verfügbar.",
  "clients.opencode.hint": "Einen Aura-Anbietereintrag für OpenCode mit geschützter Sicherung und Wiederherstellung prüfen und anwenden.",
  "clients.zcode.hint": "Es wurde noch keine stabile, maschinell konfigurierbare Integrationsoberfläche verifiziert.",
  "clients.noStableProtocol": "Kein stabiles Protokoll",
  "clients.preview": "Änderungen prüfen",
  "clients.previewReady": "Konfigurationsvorschau ist bereit.",
  "clients.previewFailed": "Client-Konfiguration konnte nicht geprüft werden.",
  "clients.previewPath": "Ziel",
  "clients.previewChanges": "Geänderte Pfade",
  "clients.connected": "Client verbunden.",
  "clients.disconnected": "Client getrennt.",
  "clients.disconnect": "Trennen",
  "clients.advanced": "Erweiterte Einstellungen",
  "clients.experimental": "Experimentell — nur manuelle Einrichtung.",
  "clients.claude-desktop.hint": "Claude Desktop mit einem geschützten Aura-Modellkatalog, Backup, Prüfung und Wiederherstellung verbinden.",
  "clients.claudeDesktopMode": "Claude-Desktop-Modus",
  "clients.claudeDesktopModels": "{count} Aura-Modelle verfügbar",
  "clients.claudeDesktopBackupReady": "Ein Konfigurations-Backup ist zur Wiederherstellung vorhanden.",
  "clients.claudeDesktopBackupOnApply": "Aura erstellt vor der Anwendung ein Backup.",
  "clients.claudeDesktopConnected": "Claude Desktop verbunden. Neustart erforderlich, um den Katalog zu laden.",
  "clients.claudeDesktopRestored": "Claude-Desktop-Konfiguration wiederhergestellt.",
  "clients.compatibleModels": "Kompatible Modelle",
  "clients.searchModels": "Modelle suchen",
  "clients.selectAllCompatible": "Alle kompatiblen auswählen",
  "clients.clearModels": "Auswahl löschen",
  "clients.defaultModel": "Standardmodell",
  "clients.connectAllHint": "Aura registriert alle ausgewählten Modelle in OpenCode; das Standardmodell startet neue Sitzungen.",
  "aura.openCodeModel": "OpenCode-Modell",
  "aura.connect": "OpenCode verbinden",
  "aura.reconnect": "OpenCode aktualisieren",
  "aura.restore": "OpenCode wiederherstellen",
  "aura.connectedState": "Verbunden",
  "aura.notConnected": "Nicht verbunden",
  "aura.connected": "OpenCode wurde verbunden.",
  "aura.restored": "OpenCode-Konfiguration wurde wiederhergestellt.",
  "aura.saved": "Routing-Profil wurde gespeichert.",
  "aura.loadFail": "Aura-Einrichtung konnte nicht geladen werden.",
  "aura.actionFail": "Aura-Aktion ist fehlgeschlagen.",
  "wizard.title": "Schnelleinrichtung",
  "wizard.subtitle": "Anbieter verbinden, Modell und Coding-Client wählen und anschließend ein Routing-Profil anwenden.",
  "wizard.step": "Schritt {current} von {total}",
  "wizard.provider": "Anbieter",
  "wizard.model": "Modell",
  "wizard.client": "Coding-Client",
  "wizard.review": "Prüfen",
  "wizard.addProvider": "Anbieter hinzufügen",
  "wizard.test": "Verbindung testen",
  "wizard.testPassed": "Anbieterverbindung erfolgreich.",
  "wizard.testFailed": "Anbieterverbindung fehlgeschlagen.",
  "wizard.continue": "Weiter",
  "wizard.back": "Zurück",
  "wizard.reviewHint": "Aura wendet das gewählte Profil an und nutzt dieses Modell für die Orchestrierung.",
  "wizard.apply": "Einrichtung anwenden",
  "wizard.applied": "Aura-Einrichtung angewendet.",
  "wizard.readyTitle": "Aura ist bereit",
  "wizard.readyHint": "Anbieter, Modell, Client und Routing-Profil sind verbunden.",
  "wizard.change": "Einrichtung ändern",
  "wizard.collapse": "Einrichtung ausblenden",
  "visual.profileAria": "Ausgewogenheit des Profils {profile}",
  "visual.efficiency": "Effizienz",
  "visual.quality": "Qualität",
  "visual.autonomy": "Autonomie",
  "visual.agents": "{n} Agenten",
  "visual.budget": "{n} Token-Budget",
  "visual.pending": "Nicht ausgewählt",
  "visual.routeTitle": "Was Aura ändert",
  "visual.routeHint": "Live-Vorschau des Pfads, dem jede Coding-Anfrage folgt.",
  "visual.ready": "Bereit",
  "visual.preview": "Vorschau",
  "visual.savingRate": "{n} % Token-Ersparnis",
  "visual.before": "vorher",
  "visual.after": "nachher",
  ...
  "appearance.subtitle": "Lege fest, wie Aura den verfügbaren Fensterplatz nutzt.",
  "appearance.layoutTitle": "Inhaltslayout",
  "appearance.layoutHint": "Wechsle sofort zwischen fokussiertem Lesefluss und responsivem Mehrspalten-Arbeitsbereich.",
  "appearance.focus": "Fokus",
  "appearance.focusHint": "Ein ruhiger einspaltiger Ablauf mit angenehmer Lesebreite.",
  "appearance.canvas": "Canvas",
  "appearance.canvasHint": "Ein adaptiver Arbeitsbereich, der zusätzliche Breite für Karten und Vergleiche nutzt.",
  "appearance.live": "Sofort wirksam",
  "lang.label": "Sprache",
  ...
  "usage.optimizer.status": "Aura-Optimierer",
  "usage.optimizer.enabled": "Aktiviert",
  "usage.optimizer.disabled": "Deaktiviert",
  "usage.optimizer.saved": "{tokens} Token durch {actions} Transformationen gespart",
  "logs.detail.optimizer": "Optimierer",
  "logs.detail.optimizerValue": "{actions} Transformationen · {tokens} Token gespart",
  "logs.detail.section.basic": "Grundinformationen",
  "logs.detail.auraClient": "Aura-Client / Protokoll",
  "logs.detail.auraProfile": "Aura-Profil",
  "logs.detail.auraRole": "Aura-Rolle",
  "logs.detail.auraReason": "Routing-Entscheidung",
  ...
  "app.claudeCliOn": "Claude Code CLI AN",
  "app.claudeCliOff": "Claude Code CLI AUS",
  "usage.dayMon": "Mo",
  "usage.dayWed": "Mi",
  "usage.dayFri": "Fr",
  ...
  "pws.capabilityTitle": "Fähigkeitsbericht",
  "pws.capabilityProtocol": "Protokoll",
  "pws.capabilityCompact": "Kompakt",
  "pws.capabilityReasoning": "Schlussfolgern",
  "pws.capabilityVision": "Bildverarbeitung",
  "pws.capabilityDeclared": "deklariert",
  "pws.capabilityUnknown": "nicht deklariert",
  "pws.capabilityProbe": "Erkennung testen",
  "pws.capabilityProbing": "Test läuft…",
  "pws.capabilityProbeOk": "Erkennung antwortete in {latency} ms.",
  "pws.capabilityProbeFailed": "Anbietererkennung fehlgeschlagen.",
  "pws.capabilityProbeNetwork": "Netzwerkfehler beim Testen der Anbietererkennung.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "aura.tokenSaver.off": "Aus",
  "aura.tokenSaver.safe": "Sicher",
